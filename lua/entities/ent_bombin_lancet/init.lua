...
util.AddNetworkString("bombin_lancet_damage_tier")
...
local function BroadcastTier(ent, tier)
	net.Start("bombin_lancet_damage_tier")
...
function ENT:Debug(msg)
	print("[Bombin Lancet] " .. tostring(msg))
end
...
function ENT:Initialize()
	...
	self.DIVE_ExplosionDamage = self:GetVar("DIVE_ExplosionDamage", 150)
	self.DIVE_ExplosionRadius = self:GetVar("DIVE_ExplosionRadius", 300)
	...
	self:SetModel("models/sw/avia/lancet3/lancet3.mdl")
...
function ENT:DiveExplode(pos)
	...
	ed2:SetOrigin(pos)
	ed2:SetScale(2) ed2:SetMagnitude(2) ed2:SetRadius(180)
	util.Effect("500lb_air", ed2, true, true)

	sound.Play("weapon_AWP.Single",               pos, 130, 75, 1.0)
